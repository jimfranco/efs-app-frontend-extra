              ...
              <v-row>
                <v-col>
                  <v-card>
                    ...
                    <v-card-actions>
                      <v-btn color="orange" @click="viewCustomers">View Details</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-col>
                <v-col>
                  <v-card>
                    ...
                    <v-card-actions>
                      <v-btn color="orange" @click="viewInvestments">View Details</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-col>
                <v-col>
                  <v-card>
                    ...
                    <v-card-actions>
                      <v-btn color="orange" @click="viewStocks">View Details</v-btn>
                    </v-card-actions>
                  </v-card> 
                </v-col>
              </v-row>
